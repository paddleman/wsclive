defmodule WscliveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WscliveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WscliveWeb.Gettext, "errors", msg, opts)
    end
  end
